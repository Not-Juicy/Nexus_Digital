        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12 border-2 border-black p-12 md:p-20 relative">
            ...
            <div className="flex flex-col sm:flex-row gap-6 w-full lg:w-auto">
              <a href="https://t.me/NexusDigital_Support" target="_blank" rel="noopener noreferrer" className="flex-1 px-8 py-5 bg-black text-white text-center font-black uppercase tracking-widest hover:bg-red-600 transition-colors flex items-center justify-center gap-3">
