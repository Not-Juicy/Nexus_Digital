        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-6 mb-16 md:mb-20">
          ...
          <div className="md:col-span-2 text-center md:text-left">
            ...
            <ul className="flex flex-col gap-3 text-sm font-bold uppercase tracking-widest leading-none">
              ...
              <li><Link to="/services" className="text-white/50 hover:text-white transition-colors">AI Agentic</Link></li>
          ...
          <div className="md:col-span-2 text-center md:text-left">
            ...
            <ul className="flex flex-col gap-3 text-sm font-bold uppercase tracking-widest leading-none">
              ...
              <li><a href="https://t.me/ndxdigital_support" target="_blank" rel="noopener noreferrer" className="text-white/50 hover:text-white transition-colors">Telegram</a></li>
            ...
            <div className="flex flex-col gap-3 text-sm font-bold uppercase tracking-widest leading-relaxed text-white/50">
              ...
              <div className="flex gap-2 pt-2">
                {[
                  ...
                  { Icon: Send, href: "https://t.me/ndxdigital_support" }
                ].map((social, i) => (
